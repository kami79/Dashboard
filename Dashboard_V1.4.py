...
def home_page():
    ...
    with col1:
        ...
        if st.session_state.get('show_ericsson', False):
            if st.button("Ericsson Sub-Dash 1"):
                navigate("Ericsson Sub-Dash 1")
            if st.button("Ericsson Sub-Dash 2"):
                navigate("Ericsson Sub-Dash 2")
            if st.button("Ericsson Sub-Dash 3"):
                navigate("Ericsson Sub-Dash 3")
    ...
    with col2:
        ...
        if st.session_state.get('show_huawei', False):
            if st.button("Huawei Sub-Dash 1"):
                navigate("Huawei Sub-Dash 1")
            if st.button("Huawei Sub-Dash 2"):
                navigate("Huawei Sub-Dash 2")
            if st.button("Huawei Sub-Dash 3"):
                navigate("Huawei Sub-Dash 3")
    ...
    with col3:
        ...
        if st.session_state.get('show_nokia', False):
            if st.button("Nokia Sub-Dash 1"):
                navigate("Nokia Sub-Dash 1")
            if st.button("Nokia Sub-Dash 2"):
                navigate("Nokia Sub-Dash 2")
            if st.button("Nokia Sub-Dash 3"):
                navigate("Nokia Sub-Dash 3")

# Functions to handle Ericsson sub-dashboards
def ericsson_sub_dash_1():
    handle_sub_dash("Ericsson Sub-Dash 1")

def ericsson_sub_dash_2():
    handle_sub_dash("Ericsson Sub-Dash 2")

def ericsson_sub_dash_3():
    handle_sub_dash("Ericsson Sub-Dash 3")

# Functions to handle Huawei sub-dashboards
def huawei_sub_dash_1():
    handle_sub_dash("Huawei Sub-Dash 1")

def huawei_sub_dash_2():
    handle_sub_dash("Huawei Sub-Dash 2")

def huawei_sub_dash_3():
    handle_sub_dash("Huawei Sub-Dash 3")

# Functions to handle Nokia sub-dashboards
def nokia_sub_dash_1():
    handle_sub_dash("Nokia Sub-Dash 1")

def nokia_sub_dash_2():
    handle_sub_dash("Nokia Sub-Dash 2")

def nokia_sub_dash_3():
    handle_sub_dash("Nokia Sub-Dash 3")

# Function to handle sub-dashboards
def handle_sub_dash(dash_name):
    st.markdown(
    ...
    if f1 is not None:
        ...
        if analyze_option == "Analyze Uploaded File":
            display_dashboard(sheets, dash_name)
...
def filter_data(df, dash_type):
 ...
 # Convert date inputs to datetime64[ns] to match the dtype of the column
    ...
    if "Ericsson" in dash_type:
        ...
        filtered_df = df[(df["Time"] >= date1) & (df["Time"] <= date2)]
...
def create_plots(df, metrics, dash_type):
    ...
    for i, metric in enumerate(metrics):
        fig = px.line(df, x="DateTime", y=metric, color=elem_col, title=f"{dash_type} - {metric} over Time")
        if i % 2 == 0:
...
if st.session_state.page == "home":
    home_page()
elif st.session_state.page == "Ericsson Sub-Dash 1":
    ericsson_sub_dash_1()
elif st.session_state.page == "Ericsson Sub-Dash 2":
    ericsson_sub_dash_2()
elif st.session_state.page == "Ericsson Sub-Dash 3":
    ericsson_sub_dash_3()
elif st.session_state.page == "Huawei Sub-Dash 1":
    huawei_sub_dash_1()
elif st.session_state.page == "Huawei Sub-Dash 2":
    huawei_sub_dash_2()
elif st.session_state.page == "Huawei Sub-Dash 3":
    huawei_sub_dash_3()
elif st.session_state.page == "Nokia Sub-Dash 1":
    nokia_sub_dash_1()
elif st.session_state.page == "Nokia Sub-Dash 2":
    nokia_sub_dash_2()
elif st.session_state.page == "Nokia Sub-Dash 3":
    nokia_sub_dash_3()
